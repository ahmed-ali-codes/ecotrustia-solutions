            ...
            <section className="relative pt-40 pb-24 px-[5%] overflow-hidden flex flex-col items-center justify-center min-h-[50vh]">
                ...
                <div className="relative z-10 max-w-5xl w-full mx-auto flex flex-col items-center text-center">
                    <h1 className="text-5xl md:text-8xl lg:text-9xl font-black mb-8 tracking-[-0.05em] leading-[0.9] text-white uppercase text-glow">
                        Miles to KM <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-500">Converter</span>
                    </h1>
                ...
                <div className="max-w-4xl w-full mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            ...
                            <div className="lg:col-span-5 space-y-6">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <FaRoad className="text-purple-500/20 text-xs" />
                                </div>
                                <div className="relative group">
                                    <div className="absolute -inset-1 bg-purple-600/5 rounded-[32px] blur opacity-0 group-focus-within:opacity-20 transition-all"></div>
                                    <div className="relative bg-[#0c0c0c] border border-white/10 rounded-[32px] p-8 flex flex-col items-center">
                                        <input 
                                            type="text" 
                                            value={miles}
                                            onChange={handleMilesChange}
                                            className="w-full bg-transparent text-center font-black text-5xl md:text-7xl text-purple-400 outline-none"
                                            placeholder="0.0"
                                        />
                            ...
                            <div className="lg:col-span-2 flex flex-col items-center justify-center gap-6">
                                <button 
                                    onClick={switchUnits}
                                    className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-purple-400 hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all active:scale-90 shadow-xl group"
                                >
                            ...
                            <div className="lg:col-span-5 space-y-6">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <FaMapMarkedAlt className="text-indigo-500/20 text-xs" />
                                </div>
                                <div className="relative group">
                                    <div className="absolute -inset-1 bg-indigo-600/5 rounded-[32px] blur opacity-0 group-focus-within:opacity-20 transition-all"></div>
                                    <div className="relative bg-[#0c0c0c] border border-white/10 rounded-[32px] p-8 flex flex-col items-center">
                                        <input 
                                            type="text" 
                                            value={kilometers}
                                            onChange={handleKilometersChange}
                                            className="w-full bg-transparent text-center font-black text-5xl md:text-7xl text-indigo-400 outline-none"
                                            placeholder="0.0"
                                        />
                        ...
                        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="p-4 px-6 rounded-2xl bg-white/[0.01] border border-white/5 backdrop-filter blur-sm">
                                    <code className="text-[10px] font-mono font-bold text-purple-500/60">Logic Basis: 1mi = 1.609344km</code>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12" style={{ marginBottom: '120px' }}>
                        <div className="mini-card group flex flex-col gap-5">
                            <FaRoute className="block text-purple-400 text-xl group-hover:scale-125 group-hover:-translate-y-1 transition-transform" />
                        ...
                        <div className="mini-card group flex flex-col gap-5">
                            <FaCalculator className="block text-indigo-400 text-xl group-hover:scale-125 group-hover:-translate-y-1 transition-transform" />
                        ...
                        <div className="mini-card group flex flex-col gap-5">
                            <FaRoad className="block text-purple-400 text-xl group-hover:scale-125 group-hover:-translate-y-1 transition-transform" />
                    ...
                    <div style={{ marginBottom: '120px' }}>
                        <ExploreTools currentPath="/tools/miles-to-kilometer" />
                    </div>
                </div>
            </section>
